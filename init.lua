...
-- format code
vim.keymap.set('n', '<leader>ff', ':lua vim.lsp.buf.format()<CR>', { desc = '[C]ode [F]ormat' })
-- vim.keymap.set('v', '<leader>fs', ':lua vim.lsp.buf.formatexpr()<CR>', { noremap = true })

-- explorer
vim.keymap.set('n', '<leader>E', ':Neotree source=filesystem reveal=true<CR>', { desc = '[E]xplorer' })

-- Enable telescope fzf native, if installed
pcall(require('telescope').load_extension, 'fzf')

-- Sees`:help telescope.builtin`
